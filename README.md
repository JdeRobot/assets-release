## jderobot_assets (melodic) - 1.0.4-3

The packages in the `jderobot_assets` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic jderobot_assets --edit` on `Wed, 17 Jun 2020 10:57:29 -0000`
...
## jderobot_assets (melodic) - 1.0.4-2

The packages in the `jderobot_assets` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic jderobot_assets --edit` on `Wed, 17 Jun 2020 10:40:21 -0000`
...
## jderobot_assets (melodic) - 1.0.4-1

The packages in the `jderobot_assets` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic jderobot_assets --edit` on `Mon, 15 Jun 2020 09:19:27 -0000`
...
## jderobot_assets (noetic) - 1.1.0-1

The packages in the `jderobot_assets` repository were released into the `noetic` distro by running `/usr/bin/bloom-release jderobot_assets --rosdistro noetic` on `Thu, 11 Jun 2020 16:48:20 -0000`
...
## jderobot_assets (melodic) - 1.0.2-2

The packages in the `jderobot_assets` repository were released into the `melodic` distro by running `/usr/bin/bloom-release jderobot_assets --rosdistro melodic --track melodic` on `Wed, 10 Jun 2020 18:56:44 -0000`
...
## jderobot_assets (melodic) - 1.0.1-1

The packages in the `jderobot_assets` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic jderobot_assets --edit` on `Thu, 26 Mar 2020 01:24:13 -0000`
